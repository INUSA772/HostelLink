...
const styles = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .rp-lbl  { display: block; font-size: 0.65rem; font-weight: 700; color: var(--text-mid); text-transform: uppercase; letter-spacing: 0.4px; margin-bottom: 0.25rem; }
  ...
  /* ── REMEMBER / FORGOT ── */
  .rp-row-flex { display: flex; justify-content: space-between; align-items: center; margin: 0.2rem 0 0.85rem; }
  ...
  .rp-forgot { font-size: 0.72rem; color: var(--teal); text-decoration: none; font-weight: 600; }
