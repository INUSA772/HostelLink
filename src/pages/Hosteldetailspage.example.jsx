...
const styles = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* Contact owner button — THE KEY FEATURE */
  .hdp-contact-btn {
...
const HostelDetailsPage = () => {
  ...
  const [contactingOwner,  setContactingOwner]  = useState(false); // ✅ NEW
  ...
  // ✅ CONTACT OWNER — starts a conversation and redirects to messages
    ...
    return (
      <>
        ...
        <div className="hdp-loading">
          ...
          <button onClick={() => navigate('/hostels')} style={{ marginTop: 12, padding: '0.5rem 1.5rem', background: 'var(--orange)', color: 'white', border: 'none', borderRadius: 8, cursor: 'pointer', fontFamily: 'Manrope', fontWeight: 700 }}>
            Back to Hostels
          </button>
        </div>
      </>
    ...
    <>
      ...
      <div className="hdp-page">
        ...
        <div className="hdp-topnav">
          ...
          <div className="hdp-topnav-actions">
            <button className={`hdp-icon-btn${isFav ? ' fav' : ''}`} onClick={() => setIsFav(!isFav)} title="Save">
              {isFav ? <FaHeart /> : <FaRegHeart />}
            </button>
            <button className="hdp-icon-btn" title="Share" onClick={() => { navigator.clipboard.writeText(window.location.href); toast.success('Link copied!'); }}>
              <FaShare />
            </button>
          </div>
        </div>
            ...
            <div className="hdp-thumbnails">
              {images.slice(0, 4).map((img, idx) => (
                <img
                  ...
                  style={{ opacity: activeImg === idx ? 1 : 0.65, outline: activeImg === idx ? '2px solid #e8501a' : 'none' }}
                />
              ))}
            </div>
          )}
          ...
          <div className="hdp-left">
            ...
            <div className="hdp-badges">
              ...
              <span className={`hdp-badge ${hostel.verified ? 'hdp-badge-verified' : 'hdp-badge-unverified'}`}>
                {hostel.verified ? <><FaCheckCircle /> Verified</> : '⏳ Pending Verification'}
              </span>
            </div>
            ...
            <div className="hdp-section">
              ...
              <div className="hdp-avail">
                <div className="hdp-avail-row">
                  ...
                  <span className="hdp-avail-val">{hostel.availableRooms} / {hostel.totalRooms}</span>
                </div>
            ...
            {hostel.owner && (
              <div className="hdp-section">
                ...
                <div className="hdp-owner-card">
                  ...
                  <div>
                    <div className="hdp-owner-name">{hostel.owner.firstName} {hostel.owner.lastName}</div>
                    <div className="hdp-owner-role">Hostel Owner</div>
                    {hostel.owner.verified && (
                      <div className="hdp-owner-verified"><FaCheckCircle /> Verified Owner</div>
                    )}
                  </div>
                </div>
              </div>
          ...
          <div className="hdp-right">
            <div className="hdp-booking-card">
              ...
              <div className="hdp-card-body">
                ...
                {/* ✅ CONTACT OWNER BUTTON — visible to everyone */}
                ...
                {/* Not logged in — show login prompt for contact */}
                {!user && (
                  <button
                    className="hdp-contact-btn"
                ...
                {/* DIVIDER — only show if student can also book */}
                    ...
                    {duration > 0 && (
                      <div className="hdp-price-breakdown">
                        ...
                        <p className="hdp-fee-note">
                          💡 Platform fee protects both students and owners from fraud
                        </p>
                      </div>
                    )}
                ...
                {/* Owner viewing their own hostel */}
                {user?.role === 'owner' && (
                ...
                {!user && (
                  <>
                    ...
                    <div className="hdp-login-prompt">
                      <p>Please <a href="/login">login as a student</a> to book this hostel or <a href="/register">create an account</a> for free.</p>
                    </div>
                  </>
                )}
      ...
      {booking && hostel && (
        <PaymentModal
          ...
          onClose={() => { setShowPaymentModal(false); setCheckInDate(''); setDuration(1); }}
